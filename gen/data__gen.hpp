...
namespace lang::data::Node {
    struct _T: langcc::hash_obj, langcc::enable_rc_from_this_poly {
        ...
        const lang::data::Node::Module_T as_Module() const;
        lang::data::Node::Param_T as_Param();
        const lang::data::Node::Param_T as_Param() const;
        lang::data::Node::SumId_T as_SumId();
        const lang::data::Node::SumId_T as_SumId() const;
        lang::data::Node::Id_T as_Id();
        const lang::data::Node::Id_T as_Id() const;
        lang::data::Node::Decl_T as_Decl();
        const lang::data::Node::Decl_T as_Decl() const;
        lang::data::Node::Mod_T as_Mod();
        const lang::data::Node::Mod_T as_Mod() const;
        lang::data::Node::Entry_T as_Entry();
        const lang::data::Node::Entry_T as_Entry() const;
        lang::data::Node::Expr_T as_Expr();
        const lang::data::Node::Expr_T as_Expr() const;
...
namespace lang::data::Node::Decl {
    struct _T: lang::data::Node::_T {
        ...
        const lang::data::Node::Decl::Include_T as_Include() const;
        lang::data::Node::Decl::Namespace_T as_Namespace();
        const lang::data::Node::Decl::Namespace_T as_Namespace() const;
        lang::data::Node::Decl::Data_T as_Data();
        const lang::data::Node::Decl::Data_T as_Data() const;
        lang::data::Node::Decl::Enum_T as_Enum();
        const lang::data::Node::Decl::Enum_T as_Enum() const;
...
namespace lang::data::Node::Mod {
    struct _T: lang::data::Node::_T {
        ...
        const lang::data::Node::Mod::Mut_T as_Mut() const;
        lang::data::Node::Mod::Xform_T as_Xform();
        const lang::data::Node::Mod::Xform_T as_Xform() const;
        lang::data::Node::Mod::Visit_T as_Visit();
        const lang::data::Node::Mod::Visit_T as_Visit() const;
...
namespace lang::data::Node::Entry {
    struct _T: lang::data::Node::_T {
        ...
        const lang::data::Node::Entry::Field_T as_Field() const;
        lang::data::Node::Entry::Method_T as_Method();
        const lang::data::Node::Entry::Method_T as_Method() const;
...
namespace lang::data::Node::Expr {
    struct _T: lang::data::Node::_T {
        ...
        const lang::data::Node::Expr::Id_T as_Id() const;
        lang::data::Node::Expr::App_T as_App();
        const lang::data::Node::Expr::App_T as_App() const;
        lang::data::Node::Expr::Type__T as_Type_();
        const lang::data::Node::Expr::Type__T as_Type_() const;
