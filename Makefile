...
ifeq ($(shell uname), Darwin)
	...
	CFLAGS_EXTRA = -D__CC__=$(CC) -D__LIBUNWIND_BACKTRACE__ -D__MACOS_SDKROOT__=$(SDKROOT) -mmacosx-version-min=12.0
	...
	CFLAGS_EXTRA = -D__CC__=$(CC) -D__LIBUNWIND_BACKTRACE__ -Wno-attributes
